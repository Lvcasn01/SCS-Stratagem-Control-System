...
CATEGORIZED_STRATAGEMS = {
    ...
    "Support Weapons": [
        ...
        "GL-52 De-Escalator", "CDC-1 One True Flag"
    ],
    "Sentry Guns": [
        "Machine Gun Sentry", "Gatling Sentry", "Mortar Sentry", "EMS Mortar Sentry",
        "Autocannon Sentry", "Rocket Sentry", "Tesla Tower", "Flame Sentry"
    ],
    "Mines and Emplacements": [
    ...
    "Backpacks": [
        ...
        "AX/LAS-5 Guard Dog", "AX/ARC-3 Guard Dog", "AD/TX-13 Guard Dog",
        "SH-20 Ballistic Shield Backpack", "SH-32 Shield Generator Pack",
        "SH-51 Directional Shield", "B-100 Portable Hellbomb"
    ],
    "Vehicles and Mechs": [
...
class ReminderWindow(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.drag_handle.setFixedHeight(10) # Small bar at the top to drag
        self.drag_handle.setStyleSheet("background-color: rgba(85, 85, 85, 220); border-top-left-radius: 5px; border-top-right-radius: 5px;")
        main_layout.addWidget(self.drag_handle)

        # Content Area
        content_widget = QWidget()
        content_widget.setStyleSheet("background-color: rgba(34, 35, 35, 200); border-bottom-left-radius: 5px; border-bottom-right-radius: 5px;")
        self.content_layout = QVBoxLayout(content_widget)
        self.content_layout.setContentsMargins(10, 5, 10, 10)
        self.label = QLabel("No hotkeys set.")
        self.label.setStyleSheet("background-color: transparent; color: white; font-size: 9pt;")
...
class StratagemMacroApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowTitle('S.C.S - Stratagem Control System v1.02')
